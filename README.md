# check-types ![CI status](https://img.shields.io/badge/build-passing-brightgreen.svg)

check-types is a package to help you check the types of a passed variable. It also allows you to check types of an object using an object scheme or an Array and types of elements within the Array.

## Installation

`$ npm install -s check-types`
